...
*(auto-generated by `mesh-common/scripts/generate-privacy-section.mjs` —
re-run after adding or removing imports from `@baditaflorin/mesh-common`)*
